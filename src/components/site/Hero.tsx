...
function MoleculeVisual() {
  return (
    <div className="relative aspect-square w-full max-w-[560px] mx-auto">
      ...
      <svg viewBox="0 0 600 600" className="relative w-full h-full" aria-hidden>
        <defs>
        ...
        {Array.from({ length: 60 }).map((_, i) => {
          ...
          const x1 = (300 + Math.cos(angle) * r1).toFixed(4);
          const y1 = (300 + Math.sin(angle) * r1).toFixed(4);
          const x2 = (300 + Math.cos(angle) * r2).toFixed(4);
          const y2 = (300 + Math.sin(angle) * r2).toFixed(4);
          return (
            <line
              key={i}
              x1={x1}
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            >
              Adhul Marketo
              <br />
              <em className="italic text-cobalt">India Pvt. Ltd.</em>
            </motion.h1>
            ...
            >
              Trusted partner for calibration gas mixtures, safety equipment and specialty gases,
              supplying India's laboratories, plants, refineries and power stations with the
              precision they run on.
            </motion.p>
