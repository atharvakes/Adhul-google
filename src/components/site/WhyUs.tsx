...
const items = [
  ...
  },
  {
    ...
    desc: "Our field engineers handle installation, commissioning and comprehensive AMC contracts directly.",
  },
  {
    n: "04",
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-10 gap-y-12 border-t hairline pt-12">
          {items.map((it, i) => (
            ...
            >
              ...
              <h3 className="mt-5 font-display text-xl text-navy leading-tight">{it.title}</h3>
