...
export function Stats() {
  return (
    <section id="trust" className="relative bg-surface border-y hairline py-10 overflow-hidden">
      ...
      <div className="mt-6 relative">
        ...
        <div className="flex marquee gap-12 whitespace-nowrap">
          {[...credentials, ...credentials].map((c, i) => (
            <div key={i} className="font-display text-2xl text-navy/70 tracking-tight">
              {c}
